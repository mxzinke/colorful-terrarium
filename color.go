...
func getColorForElevationAndTerrain(elevation, polarFactor float32, hasIce bool, desertFactor float64, isLand bool) Color {
	if !isLand && !hasIce {
		return getColorFromPalette(elevation, waterPalette)
	}
