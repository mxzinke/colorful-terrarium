...
func NewTriangle(id string, points [3]orb.Point) Triangle {
	return Triangle{id: id, points: points}
}
...
func (t Triangle) Bound() orb.Bound {
	...
	minX := min3(t.points[0][0], t.points[1][0], t.points[2][0])
	minY := min3(t.points[0][1], t.points[1][1], t.points[2][1])
	maxX := max3(t.points[0][0], t.points[1][0], t.points[2][0])
	maxY := max3(t.points[0][1], t.points[1][1], t.points[2][1])
